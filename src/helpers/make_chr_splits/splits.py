...
splits[0]['all'] = [chrom for chrom in chroms]
...
splits[1]['all'] = [chrom for chrom in chroms]
...
splits[2]['all'] = [chrom for chrom in chroms]
...
splits[3]['all'] = [chrom for chrom in chroms]
...
splits[4]['all'] = [chrom for chrom in chroms]
